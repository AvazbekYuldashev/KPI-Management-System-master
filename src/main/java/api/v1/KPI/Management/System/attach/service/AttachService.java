package api.v1.KPI.Management.System.attach.service;



import api.v1.KPI.Management.System.attach.dto.AttachDTO;
import api.v1.KPI.Management.System.attach.entity.AttachEntity;
import api.v1.KPI.Management.System.attach.repository.AttachRepository;
...
public class AttachService {
    ...
    public boolean deleteSoft(String id) {
        AttachEntity entity = getEntity(id);
        attachRepository.updateVisible(entity.getId());
    ...
    public AttachDTO getDTOById(String photoId) {
        if (photoId == null) {
            return null;
        }
